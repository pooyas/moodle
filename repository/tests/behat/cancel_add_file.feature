...
Feature: A selected file can be cancelled
  ...
  Scenario: Cancel a selected recent file from being added to a folder
    ...
    And I click on ".lion-dialogue-focused .fp-select .fp-select-cancel" "css_element"
    And I click on ".lion-dialogue-focused.filepicker .yui3-button.closebutton" "css_element"
