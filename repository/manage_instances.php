...
$url = new lion_url('/repository/manage_instances.php');

$baseurl = new lion_url('/repository/manage_instances.php');
...
if (!empty($course)) {
    ...
    $PAGE->navbar->add($fullname, new lion_url('/user/view.php', array('id'=>$user->id)));
...
/// Process the form data if any, or display
    ...
    echo $OUTPUT->header();
    $formcontinue = new single_button(new lion_url($baseurl, array('delete' => $delete, 'sure' => 'yes')), get_string('yes'));
