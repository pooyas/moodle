...
<p>Maaaring magdulot ito ng mga problemang pangmemorya sa Lion sa mga susunod na panahon, lalo na
...
<li>Kunga maaari mong gawin, muling ikompayl ang PHP na may <i>--enable-memory-limit</i>.
     Pahihintulutan nito ang Lion na itakda ang memory limit sa sarili nito.</li>
...
<li>Sa ilang PHP serve maaari kang lumikha ng isang sakong .htaccess sa bugsok ng Lion
...
$string['phpversionhelp'] = '<p>Kinakailangan ng Lion ang isang bersiyon ng PHP na kahit man lamang 4.3.0. o 5.1.0 (ang 5.0.x ay maraming problema)</p>
...
$string['welcomep30'] = 'Ang lathala ng <strong>{$a->installername}</strong> na ito ay naglalaman ng mga aplikasyon na lilikha ng kapaligiran na tatakbuhan ng  <strong>Lion</strong>, ito ay ang mga sumusunod:';
$string['welcomep40'] = 'Nilalaman din ng paketeng ito ang  <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'Dadalhin kayo ng mga sumusunod na pahina sa mga madaling hakbang upang maisaayos at mapatakbo ang <strong>Lion</strong> sa kompyuter ninyo.  Kung gusto ninyo ay panatilihin ang umiiral o kaya ay baguhin ito ayon sa inyong pangangailangan.';
$string['welcomep70'] = 'Iklik ang "Susunod" na buton sa ibaba upang maituloy ang pasasaayos ng <strong>Lion</strong>.';
