...
$string['dirroot'] = 'Lion директориум';
...
<li>Ако сте способен, повторно компајлирајте PHP со<i>--enable-memory-limit</i>.
    Ова ќе овозможи на Lion сам да го постави прагот на меморијата. </li>
...
<li>На некои PHP сервери, можете да креирате датотека .htaccess во директориумот на Lion,
...
$string['phpversionhelp'] = '<p>На Lion му е потребна верзија на PHP, и тоа најмалку 4.1.0. </p>
...
$string['welcomep30'] = 'Оваа верзија на <strong>{$a->installername}</strong> вклучува апликации за креирање околина во која <strong>Lion</strong> ќе работи:';
$string['welcomep40'] = 'Овој пакет исто така вклучува <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'Следните страници ќе Ве водат низ неколку лесни чекори за поставување на <strong>Lion</strong> на Вашиот компјутер. Може да ги прифатите стандардните поставувања, или да ги промените за Ваши потреби.';
$string['welcomep70'] = 'Кликнете на копчето „Следно“ за да продолжите со поставување на <strong>Lion</strong>.';
