...
$string['cliinstallheader'] = 'Programa d\'instal·lació de línia d\'ordres de Lion {$a}';
...
$string['dirroot'] = 'Directori de Lion';
$string['environmenthead'] = 'S\'està comprovant el vostre entorn';
$string['environmentsub2'] = 'Cada versió de Lion té uns requeriments mínims de versió de PHP i un nombre d\'extensions de PHP necessàries.
...
<p>Això pot causar que Lion tingui problemes de memòria més endavant, especialment si teniu molts mòduls habilitats i/o molts usuaris.</p>
...
<ol>
<li>Si podeu, recompileu el PHP amb <i>--enable-memory-limit</i>. Això permetrà que Lion defineixi el límit de memòria per si mateix.</li>
...
<li>En alguns servidors PHP podeu crear un fitxer .htaccess dins del directori de Lion amb aquesta línia:
...
$string['pathssubadmindir'] = 'Alguns serveis d\'allotjament web (pocs) utilitzen un URL especial /admin p. ex. per a accedir a un tauler de control o quelcom semblant. Malauradament això entra en conflicte amb la ubicació estàndard de les pàgines d\'administració de Lion. Podeu arreglar aquest problema canviant el nom del directori d\'administració de Lion en la vostra instal·lació i posant el nou nom aquí. Per exemple <em>lionadmin</em>. Això modificarà els enllaços d\'administració de Lion.';
$string['pathssubdataroot'] = 'Necessiteu un espai on Lion pugui desar els fitxers penjats. Aquest directori hauria de tenir permisos de lectura I ESCRIPTURA per a l\'usuari del servidor web (normalment \'nobody\' o \'apache\'), però no cal que sigui accessible directament via web. L\'instal·lador provarà de crear-lo si no existeix.';
$string['pathssubdirroot'] = 'Camí complet del directori d\'instal·lació de Lion.';
$string['pathssubwwwroot'] = 'L\'adreça web completa on s\'accedirà a Lion.
No és possible accedir a Lion en diferents adreces.
...
$string['phpversionhelp'] = '<p>Lion necessita una versió de PHP 4.3.0 o 5.1.0 (les versions 5.0.x tenien uns quants problemes coneguts).</p>
<p>A hores d\'ara esteu utilitzant la versió {$a}.</p>
<p>Us cal actualitzar el PHP o traslladar Lion a un ordinador amb una versió de PHP més recent.<br />(Si esteu utilitzant la versió 5.0.x, alternativament també podríeu tornar enrere a la 4.4.x)</p>';
...
$string['welcomep30'] = 'Aquesta versió de <strong>{$a->installername}</strong> inclou les aplicacions necessàries per crear un entorn en el qual funcioni <strong>Lion</strong>:';
$string['welcomep40'] = 'El paquet inclou també <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'Les pàgines següents us guiaran per una sèrie de passos fàcils de seguir per configurar <strong>Lion</strong> en el vostre ordinador. Podeu acceptar els paràmetres per defecte o, opcionalment, modificar-los perquè s\'ajustin a les vostres necessitats.';
$string['welcomep70'] = 'Feu clic en el botó "Següent" per continuar la configuració de <strong>Lion</strong>.';
