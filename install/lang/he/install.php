...
$string['cliinstallheader'] = 'תוכנית התקנת Lion {$a} בשורת הפקודה';
...
$string['dirroot'] = 'ספריית ה-Lion';
$string['environmenthead'] = 'בודק את הסביבה שלך...';
$string['environmentsub2'] = 'לכל התקנת Lion יש דרישות מינימליות לגרסת ה-PHP ומספר הרחבות הכרחי של ה-PHP.
...
דבר זה יאפשר ל-Lion להגדיר את גבול הזיכרון לבד. </i>
...
<i> בכמה שרתי PHP תוכל ליצור קובץ  .htaccess בספריית  ה-Lion שלך בצירוף שורה זו:
...
$string['pathssubdirroot'] = 'הנתיב המלא לספריית ההתקנה של Lion';
...
$string['welcomep30'] = 'גירסת <strong>{$a->installername}</strong> כוללת את היישומים ליצור סביבה אשר בה <strong> Lion </strong>
יפעל דהיינו:';
$string['welcomep40'] = 'החבילה כוללת בנוסף
<strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'העמודים הבאים יובילו אותך בצורה פשוטה דרך כמה צעדים לעיצוב הגדרות <strong>Lion</strong> במחשבך.
תוכל לאשר את הגדרות  ברירת המחדל או, באפשרותך, לשנותם לפי צרכיך.';
$string['welcomep70'] = 'הקש על לחצן ה"המשך" למטה כדי להמשיך עם הגדרת ה-<strong>Lion</strong>';
