...
$string['cliinstallheader'] = 'Lion {$a} komut satırı kurulum programı';
...
Bu, Lion\'nın kendi kendine bellek limitini ayarlasına izin verecek.</li>
...
<li>Bazı PHP sunucularında Lion klasörü içinde şu ayarı içeren bir
...
$string['pathssubadmindir'] = 'Pek az web sunucusu /admin adresini kontrol paneline yada benzeri birşeye erişmek için kullanır. Ne yazık ki bu Lion admin sayfalarının standart konumuyla bir karışıklık yaratır. Bu durumu düzeltmek için kurulumunuzdaki admin dizinini yeniden isimlendirip buraya yeni ismi yazınız. Örneğin: <em>lionadmin</em>. Bu Lion\'daki admin bağlantısını düzeltecektir.';
$string['pathssubdataroot'] = '<p>Lion\'ın yüklenen dosyaları kayıt etmesi için bir yere ihtiyacınız var. </p>
...
$string['pathssubdirroot'] = '<p>Lion kurulumu için tam klasör yolu.</p >';
$string['pathssubwwwroot'] = '<p>Lion\'a erişilecek tam web adresi. Lion\'ın birden çok adres kullanması mümkün değildir. </p>
...
$string['phpversionhelp'] = '<p>Lion, PHP sürümünün en az 4.3.0 veya 5.1.0 olmasını gerektirir (5.0.x sürümünde çok fazla hata var).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>\'nin bu sürümü <strong>Lion</strong>\'da bir ortam oluşturmak için uygulamaları içerir:';
$string['welcomep40'] = 'Bu paket <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong> sürümünü de içerir.';
...
$string['welcomep60'] = 'Aşağıdaki sayfalar <strong>Lion</strong>ın kurulumu ve yapılandırılması için size basitçe yol gösterecektir. Varsayılan ayarları kabul edebilir veya ihtiyaçlarınıza göre bunları değiştirebilirsiniz.';
$string['welcomep70'] = '<strong>Lion</strong> kurulumu için aşağıdaki "İleri" tuşuna basın.';
