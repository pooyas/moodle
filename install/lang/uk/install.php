...
$string['cliinstallheader'] = 'Lion {$a} командний рядок програми установки';
...
$string['dirroot'] = 'Lion Каталог';
$string['environmenthead'] = 'Перевірка залежностей...';
$string['environmentsub2'] = 'Кожен Lion реліз вимагає деяку мінімальну версію РНР та специфічний набір додаткових розширень. Повна перевірка проводиться до початку встановлення або оновлення. Будь ласка, зв’яжіться з вашим адміністратором, якщо ви не знаєте, як встановити нову версію або налаштувати РНР.';
...
$string['memorylimithelp'] = '<p>Обмеження пам\'яті в PHP на сервері зараз встановлено в {$a}.</p> <p>Це може стати проблемою при подальшій роботі Lion, коли ви будете мати багато курсів, модулів та користувачів.</p> <p>Ми рекомендуємо сконфігурувати РНР на обмеження пам\'яті не менше 16 Мб. Це можна зробити шляхом:</p> <ol> <li>перекомпіляції PHP з параметром <i>--enable-memory-limit</i>. Це надасть можливість Lion встановити обмеження пам\'яті самостійно.</li> <li>встановлення в php.ini змінної <b>memory_limit</b> порядка 16Mб. Якщо ви не маєте доступу до цього файлу попросіть адміністратора зробити це для вас.</li> <li>створення в корні сайту файлу .htaccess, куди добавити наступний рядок: <p><blockquote>php_value memory_limit 16M</blockquote></p> <p>Але на деяких серверах це призведе до помилок на <b>всіх</b> сторінках, тоді вам потрібно видалити .htaccess.</p></li> </ol>';
$string['paths'] = 'Шляхи';
...
$string['pathssubadmindir'] = 'Дуже мало web хостингів використовують /admin в якості спеціальної адреси для доступу до адміністративного управління. На жаль, це суперечить стандартному розташуванню сторінок адміністрування для Lion. Ви можете виправити це перейменуванням каталогу admin в будь-яке інше ім’я та вписати його тут. Наприклад: <em>lionadmin</em>. Це виправить посилання на адміністрування в Lion.';
$string['pathssubdataroot'] = '<p>Каталог, де Lion буде зберігати всі файли, які завантажують користувачі.</p>
...
$string['pathssubdirroot'] = '<p>Повний шлях до каталогу встановлення lion.</p>';
$string['pathssubwwwroot'] = '<p>Повна веб-адреса, за якою ваш сайт lion буде доступним. Lion може мати тільки одну адресу доступу. </p>
...
$string['phpversionhelp'] = '<p>Lion потребує PHP версії не менше ніж 4.3.0 або 5.1.0 (версії 5.0.x мають деякі відомі проблеми).</p> <p>Наразі ви працюєте з версією {$a}</p> <p>Вам потрібно оновити PHP або змінити хост з новішою версією PHP!<br /> (У разі 5.0.x ви також можете повернутися до версії 4.4.x)</p>';
...
$string['welcomep30'] = 'Цей випуск <strong>{$a->installername}</strong> включає в себе програми для створення середовища, в якому <strong>Lion</strong> працюватиме, а саме:';
$string['welcomep40'] = 'Цей пакет також включає <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'Наступні сторінки будуть проводити вас через процедуру встановлення та налаштування <strong>Lion</strong> на вашому комп’ютері. Ви можете прийняти автоматичне налаштування, а потім змінити параметри під себе.';
$string['welcomep70'] = 'Натисніть кнопку "Далі" для продовження встановлення <strong>Lion</strong>.';
