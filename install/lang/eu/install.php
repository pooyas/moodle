...
$string['dirroot'] = 'Lion direktorioa';
...
<p>Aurrerago honek Lion-ri arazoak sor diezaizkioke, bereziki modulu edo/eta erabiltzaile asko badituzu.</p>
...
Horrek Lion-k berak memoria-muga ezartzea ahalbidetzen du.</li>
...
<li>PHP zerbitzari batzuetan Lion-ren direktorioan beheko lerro hau daukan .htaccess fitxategia sor dezakezu:
...
$string['phpversionhelp'] = '<p>Lion-k gutxienez PHP 4.3.0 edo 5.1.0 (5.0.x errore batzuk ditu). </p>
<p>Zure bertsioa: {$a}</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>ren bertsio honek <strong>Lion</strong>k
    zure ordenadorean funtzionatzeko behar diren aplikazioak dauzka,
    bereziki:';
$string['welcomep40'] = 'Paketeak ere zera dauka: <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'Datozen orriek urrats erraz batzuen bidez gidatuko zaituzte
   <strong>Lion</strong> zure ordenadorean instalatu eta konfiguratzeko. Aholkatzen diren lehentsitako baloreak
   mantendu edo, nahi izanez gero, alda ditzakezu zure beharrei erantzun diezaieten.';
$string['welcomep70'] = '"Hurrengoa" botoia sakatu <strong>Lion</strong>ren konfigurazioarekin jarraitzeko.';
