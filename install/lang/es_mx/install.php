...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, use admin/cli/install_database.php para instalar Lion para este sitio';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar Lion para este sitio.';
...
$string['dirroot'] = 'Directorio Lion';
$string['environmenthead'] = 'Comprobando su entorno';
$string['environmentsub2'] = 'Cada versión de Lion tiene algún requisito mínimo de la versión de PHP y un número obligatorio de extensiones de PHP. Una comprobación del entorno completo se realiza antes de cada instalación y actualización. Por favor, póngase en contacto con el administrador del servidor si no sabe cómo instalar la nueva versión o habilitar las extensiones PHP.';
...
$string['pathssubdataroot'] = '<p>Un directorio en donde Lion almacenará todo el contenido de los archivos subidos por usuarios.</p>
...
$string['pathssubdirroot'] = '<p> La ruta completa al directorio que contiene el código de Lion.</p>';
$string['pathssubwwwroot'] = '<p>La dirección completa desde donde se accederá a Lion; o sea, la dirección que los usuarios escribirán en la barra de dirección de su navegador para acceder a Lion.</p>
<p>No es posible acceder a Lion usando direcciones múltiples. Si su sitio fuera accesible desde direcciones múltiples, entonces elija la más sencilla y configure una redirección permanente para cada una de las otras direcciones.</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las aplicaciones necesarias para que <strong>Lion</strong> funcione en su computadora,  principalmente:';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar y ajustar <strong>Lion</strong> en su computadora. Puede utilizar los valores por defecto sugeridos o, de forma opcional, modificarlos para que se ajusten a sus necesidades.';
