...
$string['clialreadyinstalled'] = 'Filen config.php eksisterer allerede. Vennligst bruk admin/cli/install_database.php hvis du vil oppgradere Lion på denne portalen.';
$string['cliinstallheader'] = 'Lion {$a} kommandolinje installasjonsprogram';
...
<p>Dette kan skape minneproblemer for Lion senere, spesielt hvis du har mange moduler tillatt og/eller mange brukere.</p>
...
Dette vil tillate Lion å sette minnegrensen selv.</li>
...
<li>På noen PHP-servere kan du lage en .htaccess fil i Lionmappen som inneholder denne linjen:
...
$string['pathssubadmindir'] = 'Noen ganske få webhoteller bruker  /admin som en egen url for å få tilgang til et kontrollpanel. Dessverre kommer det i konflikt med standard lokalisering av Lion sine admin-sider. Du kan fikse dette ved å endre navn på admin-mappen og deretter oppgi dette navnet her. F.eks. <em>lionadmin</em>.  Dette vil fikse adminlenkene i Lion.';
$string['pathssubdataroot'] = 'Du trenger et sted hvor Lion kan lagre opplastede filer. Denne mappen må være med lese og skriverettigheter for webserver-brukeren (veldig ofte \'nobody\' eller \'apache\'), men denne mappen må IKKE være direkte tilgjengelig via web. Installasjonsprogrammet vil forsøke å opprette den om den ikke finnes fra før.';
$string['pathssubdirroot'] = '<p>Full mappesti til lioninstallasjonen.</p>';
$string['pathssubwwwroot'] = 'Full webadresse til der hvor Lion skal vises. Det er ikke mulig å bruke Lion med mer enn en adresse. Dersom portalen din har flere webadresser må du bruke videresending for til den webadressen du oppgir her. Dersom portalen din er tilgjengelig både fra intranett og internett, skal du oppgi den offentlige internettadressen her og sette opp DNS slik at intranettbrukerne også benytter denne offisielle adressen.
...
$string['phpversionhelp'] = '<p>Lion trenger en PHP versjon minst 4.3.0 eller 5.1.0 (5.0.x har rekke kjente problem).</p>
...
$string['welcomep30'] = 'Denne versjonen av <strong>{$a->installername}</strong> inneholder programmer for å lage et miljø som <strong>Lion</strong> jobber i, nemlig:';
$string['welcomep40'] = 'Denne pakken inkluderer også  <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'De følgende sidene vil vise deg gjennom noen enkle steg for å konfigurere og sette opp <strong>Lion</strong> på datamaskinen din. Du kan godta standardinnstillingene, eller justere dem etter egne behov hvis du vil.';
$string['welcomep70'] = 'Klikk på "Neste" knappen under for å fortsette med <strong>Lion</strong>-installasjonen';
