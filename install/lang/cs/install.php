...
$string['cliinstallheader'] = 'Lion {$a} - průvodce instalací z příkazové řádky';
...
$string['environmentsub2'] = 'Každé vydání Lion vyžaduje určitou minimální verzi PHP a několik povinných rozšíření PHP. Plná kontrola prostředí se provádí před každým instalací a upgrade. Prosím, kontaktujte správce serveru, pokud nevíte, jak nainstalovat novou verzi, nebo povolit rozšíření PHP.';
...
Lion si tak bude sám moci nastavit potřebný limit.</li>
...
$string['pathssubadmindir'] = 'Na některých serverech je URL adresa /admin vyhrazena pro speciální účely (např. pro ovládací panel). Na takových serverech může dojít ke kolizi se standardním umístěním stránek pro správu Lion. Máte-li tento problém, přejmenujte adresář <eM>admin</em> ve vaší instalaci Lion a sem zadejte jeho nový název - například <em>lionadmin</em>. Všechny generované odkazy na stránky správy Lion budou používat tento nový název.';
$string['pathssubdataroot'] = 'Lion potřebuje prostor, kam si bude ukládat nahrané soubory a další údaje. K tomuto adresáři musí mít proces webového serveru právo ke čtení i k zápisu (webový server bývá většinou spouštěn pod uživatelem "www-data" nebo "apache"). Tento adresář ale zároveň nesmí být dostupný přímo přes webové rozhraní. Instalační skript se pokusí tento adresář vytvořit, pokud nebude existovat.';
$string['pathssubdirroot'] = 'Absolutní cesta k adresáři s instalací Lion';
$string['pathssubwwwroot'] = 'Zadejte úplnou webovou adresu, na níž bude Lion dostupný. Lion potřebuje jedinečnou adresu, není možné jej provozovat na několika URL současně. Používáte-li několik veřejných domén, musíte si sami nastavit permanentní přesměrování na jednu z nich a tu pak použít. Pokud je váš server dostupný z vnější a z vnitřní sítě pod různými IP adresami, použijte jeho veřejnou adresu a nastavte si váš DNS server tak, že ji mohou používat i uživatelé z vnitřní sítě.';
...
$string['phpversionhelp'] = '<p>Lion vyžaduje PHP alespoň verze 4.3.0 nebo 5.1.0 (PHP 5.0.x obsahuje množství chyb).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong> obsahuje aplikace k vytvoření prostředí, ve kterém bude provozován váš <strong>Lion</strong>. Jmenovitě se jedná o:';
$string['welcomep40'] = 'Balíček rovněž obsahuje <strong>Lion ve verzi {$a->lionrelease} ({$a->lionversion})</strong>.';
