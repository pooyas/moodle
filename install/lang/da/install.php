...
$string['cliinstallheader'] = 'Lion {$a} kommandolinje-installationsprogram';
...
$string['dirroot'] = 'Lion-mappe';
$string['environmenthead'] = 'Kontrollerer din serveropsætning...';
$string['environmentsub2'] = 'Hver version af Lion har nogle minimumskrav til PHP-version og nogle obligatoriske PHP-extensions.
...
Det vil tillade at Lion selv kan definere hvor meget hukommelse der er brug for.</li>
...
<li>På nogle servere kan du oprette en \'.htaccess\' fil og gemme den i lion-mappen med linjen:
...
$string['pathssubadmindir'] = 'Enkelte webhoteller bruger /admin som speciel URL til kontrolpanelet el. lign. Desværre konflikter det med Lions standardplacering af admin-sider. Du kan klare dette ved at give admin-mappen et andet navn i din installation og skrive det her. Det kan f.eks. være <em>lionadmin</em>. Det vil fikse admin-links i Lion.';
...
$string['pathssubdirroot'] = 'Den fulde sti til Lioninstallationen.';
$string['pathssubwwwroot'] = 'Lions fulde web-adresse.
Det er ikke muligt at komme ind på Lion fra mere end en adresse.
...
$string['phpversionhelp'] = '<p>Lion kræver mindst PHP version 4.3.0. eller 5.1.0 (5.0.x er behæftet med fejl).</p>
...
Tillykke med det!';
$string['welcomep30'] = 'Denne udgave af <strong>{$a->installername}</strong> indeholder programmerne til at oprette et miljø, hvori <strong>Lion</strong> vil operere, nemlig:';
$string['welcomep40'] = 'Pakken indeholder også <strong>Lion {$a->lionrelease} ({$a->lionversion})</strong>.';
...
$string['welcomep60'] = 'De følgende sider vil hjælpe dig gennem nogle nemme trin til konfiguration og opsætning af <strong>Lion</strong> på din computer. Du kan acceptere standardindstillingerne eller vælge at ændre dem så de bedre svarer til dine egne behov.';
$string['welcomep70'] = 'Klik på "Næste" herunder for at forsætte opsætningen af <strong>Lion</strong>.';
