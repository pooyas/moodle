...
/**
 * Strings for component 'imscc', language 'en', branch 'LION_20_STABLE'
 *
 * @package    core
 * @subpackage imscc
...
$string['cc2lion_checking_schema'] = 'CC format! Checking schema...';
$string['cc2lion_invalid_schema'] = 'The schema is not valid.';
$string['cc2lion_manifest_dont_load'] = 'Cannot load the XML manifest.';
$string['cc2lion_req_auth'] = 'ERROR: The Common Cartridge package requires authorization.';
$string['cc2lion_valid_schema'] = 'Schema valid!';
