...
/**
 * Strings for component 'lion', language 'en', branch 'LION_20_STABLE'
 *
 * @package    lang
 * @subpackage en
...
$string['adminhelpmylion'] = 'Configure the My Lion blocks for users';
...
$string['adminhelpstickyblocks'] = 'Configure Lion-wide sticky blocks';
...
$string['backupnonisowarning'] = 'Warning: this backup is from a non-Unicode version of Lion (pre 1.6).  If this backup contains any non-ISO-8859-1 texts then they may be CORRUPTED if you try to restore them to this Unicode version of Lion.  See the <a href="http://docs.lion.org/en/Backup_FAQ">Backup FAQ</a> for more information about how to recover this backup correctly.';
...
$string['clamlost'] = 'Lion is configured to run clam on file upload, but the path supplied to Clam AV, {$a},  is invalid.';
$string['clamlostandactinglikevirus'] = 'In addition, Lion is configured so that if clam fails to run, files are treated like viruses.  This essentially means that no student can upload a file successfully until you fix this.';
...
The essential one is the session cookie, usually called LionSession. You must allow this cookie into your browser to provide continuity and maintain your login from page to page. When you log out or close the browser this cookie is destroyed (in your browser and on the server).

The other cookie is purely for convenience, usually called something like LIONID. It just remembers your username within the browser. This means when you return to this site the username field on the login page will be already filled out for you. It is safe to refuse this cookie - you will just have to retype your username every time you log in.';
...
$string['coursefileswarning_help'] = 'Course files are deprecated since Lion 2.0, please use external repositories instead as much as possible.';
...
$string['courselegacyfiles_help'] = 'The course files area provides some backward compatibility with Lion 1.9 and earlier.  All files in this area are always accessible to all participants in the course (whether you link to them or not) and there is no way to know where any of these files are being used in Lion.
...
$string['databasechecking'] = 'Upgrading Lion database from version {$a->oldversion} to {$a->newversion}';
...
$string['documentation'] = 'Lion documentation';
...
$string['formattext'] = 'Lion auto-format';
...
$string['go'] = 'Go';
$string['gpl'] = 'Copyright (C) 1999 onwards  Martin Dougiamas  (http://lion.com)
...
See the Lion License information page for full details:
http://docs.lion.org/dev/License';
$string['gpllicense'] = 'GPL license';
$string['gpl3'] = 'Copyright (C) 1999 onwards Martin Dougiamas (http://lion.com)
...
$string['gravatarenabled'] = '<a href="http://www.gravatar.com/">Gravatar</a> has been enabled for this site. If you don\'t upload a profile picture Lion will attempt to load a profile picture for you from Gravatar.';
$string['group'] = 'Group';
...
$string['latestlanguagepack'] = 'Check for latest language pack on lion.org';
...
$string['liondocs'] = 'Lion Docs';
$string['liondocslink'] = 'Lion Docs for this page';
$string['lionversion'] = 'Lion version';
$string['lionrelease'] = 'Lion release';
$string['more'] = 'more';
...
$string['myliondashboard'] = 'My Lion dashboard';
...
$string['noticenewerbackup'] = 'This backup file has been created with Lion {$a->backuprelease} ({$a->backupversion}) and it\'s newer than your currently installed Lion {$a->serverrelease} ({$a->serverversion}). This could cause some inconsistencies because backwards compatibility of backup files cannot be guaranteed.';
...
$string['passwordextlink'] = 'The following link has been provided to recover your lost password. This will take you out of Lion.';
...
$string['passwordnohelp'] = 'No help is available to find your lost password. Please contact your Lion administrator.';
...
$string['registration'] = 'Lion registration';
...
$string['registrationcontactyes'] = 'Yes, provide a form for prospective Lionrs to contact me';
$string['registrationemail'] = 'Email notifications';
$string['registrationinfo'] = '<p>This page allows you to register your Lion site with lion.org.  Registration is free.
The main benefit of registering is that you will be added to a low-volume mailing list
for important notifications such as security alerts and new releases of Lion.</p>
<p>By default, your information will be kept private, and will never be sold or passed on to anyone else.  The only
   ...
   picture of the Lion community as a whole.</p>
<p>If you choose, you can allow your site name, country and URL to be added to the public list of Lion Sites.</p>
...
$string['registrationsend'] = 'Send registration information to lion.org';
...
$string['updatemylionoff'] = 'Stop customising this page';
$string['updatemylionon'] = 'Customise this page';
...
$string['virusfoundlateradminnolog'] = 'Attention administrator! A file that was uploaded with the filename {$a->filename} has since been found to contain a virus. Lion was unable to resolve this file back to the user that originally uploaded it.
