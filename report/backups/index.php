...
if ($courseid) {
    ...
    if (isset($backup)) {
        ...
        $baseurl = new lion_url('/report/backups/index.php', array('courseid' => $courseid));
...
foreach ($rs as $backuprow) {
    ...
    $backuplogsurl = new lion_url('/report/backups/index.php', array('courseid' => $backuprow->courseid));
