...
class edit_outcome_form extends lionform {
...
/// tweak the form - depending on existing data
    function definition_after_data() {
        ...
        if ($id = $mform->getElementValue('id')) {
            ...
            } else if (!has_capability('lion/grade:manage', context_system::instance())) {
                $mform->hardFreeze('standard');
            ...
            if (empty($courseid) or !has_capability('lion/grade:manage', context_system::instance())) {
                $mform->hardFreeze('standard');
            }
        }
    }
