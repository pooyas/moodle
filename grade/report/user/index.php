...
$PAGE->set_url(new lion_url('/grade/report/user/index.php', array('id'=>$courseid)));
...
if (has_capability('lion/grade:viewall', $context)) { //Teachers will see all student reports
    ...
    if (empty($userid)) {
        ...
        while ($userdata = $gui->next_user()) {
            ...
            $studentnamelink = html_writer::link(new lion_url('/user/view.php', array('id' => $report->user->id, 'course' => $courseid)), fullname($report->user));
