...
class grade_report_user extends grade_report {
    ...
    public function __construct($courseid, $gpr, $context, $userid, $viewasuser = null) {
        ...
        if ($viewasuser) {
            ...
            $this->canviewhidden = has_capability('lion/grade:viewhidden', $coursecontext, $this->user->id);
        } else {
            $this->modinfo = $this->gtree->modinfo;
            $this->canviewhidden = has_capability('lion/grade:viewhidden', $coursecontext);
        }
