...
$PAGE->set_url(new lion_url('/grade/report/singleview/index.php', $courseparams));
...
$currentpage = new lion_url('/grade/report/singleview/index.php', $pageparams);
...
if (!empty($options)) {
    ...
    if ($i > 0) {
        ...
        $link = new lion_url('/grade/report/singleview/index.php', $navparams);
