...
if ($returnurl) {
    ...
    $returnurl = new lion_url('/cohort/index.php', array('contextid'=>$context->id));
}
...
$baseurl = new lion_url('/cohort/edit.php', array('contextid' => $context->id, 'id' => $cohort->id));
...
if ($delete and $cohort->id) {
    ...
    $yesurl = new lion_url('/cohort/edit.php', array('id' => $cohort->id, 'delete' => 1,
...
if ($editform->is_cancelled()) {
    ...
    if ($returnurl->get_param('showall') || $returnurl->get_param('contextid') == $data->contextid) {
        ...
        redirect(new lion_url('/cohort/index.php', array('contextid' => $data->contextid)));
    }
}
