...
if (is_siteadmin()) {
    ...
    $donate = new lion_url('http://lion.org/user/profile.php?id=442195');
    $donate = html_writer::link($donate, get_string('paypal_click', 'theme_essential'), array('target' => '_blank'));

    $flattr = new lion_url('https://flattr.com/profile/gjb2048');
    ...
    $readme = new lion_url('/theme/essential/README.txt');
