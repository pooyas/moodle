...
<p>Essential is based upon the Bootstrap theme, which was created for Lion 2.5, with the help of:<br>
...
<h4>PayPal</h4>
<p>Please contact me via my <a href="http://lion.org/user/profile.php?id=442195" target="_blank">\'Lion profile\'</a> for details as I am an individual and therefore am unable to have \'donation\' / \'buy me now\' buttons under their terms.</p>
<h4>Flattr</h4>
...
$string['fontheadingdesc'] = 'Select and enter the fonts that you want to use in your Lion environment.';
...
$string['fontcharactersetdesc'] = 'Pick additional character sets for different languages.
                                   Using many character sets can slow down your Lion, so only select the character sets that you actually need.';
...
$string['layoutdesc'] = 'This theme is designed to put both block columns on the side.  If you prefer the standard Lion course layout you can check this box and be returned to the boring old three column layout.';
...
$string['paypal_click'] = 'Lion profile';
...
$string['themecolordesc'] = 'What colour should your theme be.  This will change multiple components to produce the colour you wish across the Lion site';
...
$string['frontpageblocksdesc'] = 'Here you can determine if the standard Lion blocks on the frontpage align to the left or the right.';
...
$string['androiddesc'] = 'Provide an URL to your mobile App on the Google Play Store.  If you do not have one of your own maybe consider linking to the official Lion Mobile app. (https://play.google.com/store/apps/details?id=com.lion.lionmobile)';

$string['windows'] = 'Windows Desktop';
$string['windowsurl'] = 'Windows Desktop URL';
$string['windowsdesc'] = 'Provide an URL to your mobile App on the Windows Store.  If you do not have one of your own maybe consider linking to the official Lion Mobile app. (http://apps.microsoft.com/windows/en-us/app/9df51338-015c-41b7-8a85-db2fdfb870bc)';

$string['winphone'] = 'Windows Mobile';
$string['winphoneurl'] = 'Windows Mobile URL';
$string['winphonedesc'] = 'Provide an URL to your mobile App on the Google Play Store.  If you do not have one of your own maybe consider linking to the official Lion Mobile app. (http://www.windowsphone.com/en-us/store/app/lionmobile/d0732b88-3c6d-4127-8f24-3fca2452a4dc)';

$string['ios'] = 'iPhone/iPad (App Store)';
$string['iosurl'] = 'iPhone/iPad (App Store) URL';
$string['iosdesc'] = 'Provide an URL to your mobile App on the App Store.  If you do not have one of your own maybe consider linking to the official Lion Mobile app (https://itunes.apple.com/en/app/lion-mobile/id633359593).';
...
$string['analyticsheadingsub'] = 'Powerful analytics for Lion';
...
$string['analyticsenableddesc'] = 'Enable analytics for Lion';
...
$string['alertsdesc'] = 'This will display an alert (or multiple) in three different styles to your users on the Lion frontpage. Please remember to disable these when no longer needed.';
