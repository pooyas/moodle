...
The idea of this theme is to make the site look as little like Lion as possible. In this specific instance, it would be used
on sites where Lion would potentially serve as a company homepage rather than just a course list.
...
Cool things to know about the theme.
 ...
 - I am really trying to push what [Bootstrap](http://twitter.github.io/bootstrap/) Grids can do. As such the theme is fully
   responsive.
 - The footer is all custom Lion regions. This means blocks can be added. The footer of the demo site is full of HTML blocks in
   this instance
...
===============
Julian Ridden
Lion profile: https://lion.org/user/profile.php?id=39680
Web profile:    http://au.linkedin.com/in/eduridden/

Previous Authors
================
David Bezemer
Lion profile | https://lion.org/user/profile.php?id=1416592
...
lion.org/mod/forum/view.php?id=46 is an excellent place to ask questions.
...
PayPal - Please contact me via my 'Lion profile' (above) for details as I am an individual and therefore am unable to have
...
============
 ...
 2. Login as an administrator and put Lion in 'Maintenance Mode' so that there are no users using it bar you as the
    administrator.
...
2.  Put Lion into 'Maintenance mode' under 'Home -> Administration -> Site administration -> Server -> Maintenance mode', so that
...
It has been removed because of licencing issues: https://github.com/gjb2048/lion-theme_essential/issues/61
...
WOFF2 Font Support
==================
WOFF2 font support will automatically kick in if you are running Lion 2.8.5+ (Build: 20150313) - 2014111005.01 or above.  If you
...
- NEW: Updated to FontAwesome 4.3.0 with WOFF2 font support.  Requires 2.8.5+ (Build: 20150313) - 
       https://lion.org/mod/forum/discuss.php?d=307270
- NEW: Dynamic WOFF2 support based upon Lion version - see: MDL-49074.
...
- FIX: Issue #309: Lion 2.8 file manager issue.
...
- FIX: Issue #310: Lion TinyMCE editor issue.
                   Thanks to Mary Evans for the fix on: https://lion.org/mod/forum/discuss.php?d=275976 and
...
- FIX: Issue #352: Piwik function clash with local plugin version - https://lion.org/plugins/view.php?plugin=local_analytics.
...
- UPDATE         : lion/core.less - MDL-47340 & MDL-47097.
- UPDATE         : lion/course.less - MDL-47340.
- UPDATE         : lion/responsive.less - MDL-47242.
...
- FIX: Issue #220: Standard Lion Chat interface fails to load.
...
- NEW: Backported to Lion 2.5!!!
- HELP WANTED: All language strings are now in AMOS (Lion Language packs) please update your own language!
...
- NEW: Warning about IE8 as M2.6 does not support it - http://docs.lion.org/dev/Lion_2.6_release_notes#Requirements.
...
- NEW: Moved layouts to a more "Lion standard" 1, 2 and 3 column layout.
...
- UPDATE: Removing autohide feature as no longer needed in Lion 2.6
...
- Now has a companion Mahara ePorfolio theme so you can keep them looking alike - https://github.com/lionman/mahara-theme_essential
...
- Advanced Google Analytics function allowing Clean URL's for better reporting. Contributed by @basbrands and @ghenrick. More info
  on this feature can be found on http://www.somerandomthoughts.com/blog/2012/04/18/ireland-uk-lionmoot-analytics-to-the-front/
...
- Many CSS Fixes
- IMPORTANT: Theme requires Lion 2.5.1 or higher
...
- Now available in English, German, Russian, Turkish and Spanish (many thanks to the Lion Community for translating)
