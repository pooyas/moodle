 ...
 *                                 path to your Lion root directory
 ...
 *
 * grunt decache      Clears the Lion theme cache.
 *
 *                    Options:
 *
 *                    --dirroot=<path>  Optional. Explicitly define
 *                                      the path to your Lion root
...
module.exports = function(grunt) {
    ...
    var LESSDIR         = 'less',
        LIONURLPREFIX = grunt.option('urlprefix') || '',
    ...
    grunt.initConfig({
        less: {
            ...
            lion_rtl_p: {
                ...
                src: 'less/lion-rtl.less',
                dest: 'style/lion-rtl.css'
            },
            bootstrap_pix_p: {
                options: {
                    compress: false,
            ...
            lion_pix_p: {
                ...
                src: 'less/lion-pix.less',
                dest: 'style/lion-pix.css'
            },
            essential_pix_p: {
                options: {
                    compress: false,
            ...
            essential_d: { // Flipped.
                options: {
                    ...
                    report: 'min',
                    sourceMap: true,
                    sourceMapRootpath: LIONURLPREFIX + '/theme/' + THEMEDIR,
            ...
            lion_rtl_d: {
                options: {
                    ...
                    sourceMap: true,
                    sourceMapRootpath: LIONURLPREFIX + '/theme/' + THEMEDIR,
                    sourceMapFilename: 'style/lion-rtl.treasure.map'
                },
                src: 'less/lion-rtl.less',
                dest: 'style/lion-rtl.css'
            },
            ...
            lion_pix_d: {
                options: {
                    ...
                    sourceMap: true,
                    sourceMapRootpath: LIONURLPREFIX + '/theme/' + THEMEDIR,
                    sourceMapFilename: 'style/lion-pix.treasure.map'
                },
                src: 'less/lion-pix.less',
                dest: 'style/lion-pix.css'
            },
        ...
        exec: {
            decache: {
                ...
                callback: function(error, stdout, stderror) {
                    ...
                    if (!error) {
                        grunt.log.writeln("Lion theme cache reset.");
                    }
                }
            }
        },
         ...
         cssmin: {
            essential_p: {
                files: [{
                    expand: true,
                    cwd: 'style',
                    src: ['essential.css', 'essential-rtl.css', 'bootstrap-pix.css', 'lion-pix.css', 'essential-pix.css', 'essential-alternative.css', 'editor.css', 'fontawesome-woff2.css', 'fontawesome-no-woff2.css', 'fontawesome.css', 'lion-rtl.css'],
                    dest: 'style',
                    ext: '.css'
                }]
            }
    ...
    grunt.registerTask("css", ["less:essential_"+build, "less:editor_"+build, "less:lion_rtl_"+build, "less:settings_"+build, "less:bootstrap_pix_"+build, "less:lion_pix_"+build, "less:essential_pix_"+build, "less:fontawesome_woff2_"+build, "less:fontawesome_no_woff2_"+build, "less:fontawesome_"+build, "less:alternative_"+build]);
    if (build == 'd') {
