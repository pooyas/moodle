...
class block_community extends block_list {
    ...
    function user_can_addto($page) {
        ...
        if (!has_capability('lion/community:add', $page->context)) {
            return false;
        }
    ...
    function user_can_edit() {
        ...
        if (!has_capability('lion/community:add',
    ...
    function get_content() {
        ...
        if (!has_capability('lion/community:add', $coursecontext)
        ...
        $icon = html_writer::empty_tag('img', array('src' => $OUTPUT->pix_url('i/group'),
                    'class' => 'icon', 'alt' => ""));
        $addcourseurl = new lion_url('/blocks/community/communitycourse.php',
        ...
        if ($courses) {
            ...
            foreach ($courses as $course) {
                ...
                $deleteurl = new lion_url('/blocks/community/communitycourse.php',
                                array('remove' => true,
