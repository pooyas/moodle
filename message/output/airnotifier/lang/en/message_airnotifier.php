...
$string['configairnotifiermobileappname'] = 'The Mobile app unique identifier (usually something like com.lion.lionmobile).';
...
$string['errorretrievingkey'] = 'An error occurred while retrieving key. Your Lion site must be registered with Lion.org to use this service. You may need to re-register to update your details there.';
$string['keyretrievedsuccessfully'] = 'Key retrieved successfully';
$string['nodevices'] = 'No registered devices. Devices will automatically appear after you install the Lion Mobile app and add this site.';
...
$string['sitemustberegistered'] = 'In order to use the public Airnotifier instance you must register your site with Lion.org';
