...
$PAGE->navbar->add($strdata, new lion_url('/mod/data/index.php', array('id'=>$course->id)));
...
if (! $datas = get_all_instances_in_course("data", $course)) {
    notice(get_string('thereareno', 'lion',$strdataplural) , "$CFG->wwwroot/course/view.php?id=$course->id");
}
