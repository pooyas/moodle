...
$url = new lion_url('/mod/quiz/overridedelete.php', array('id'=>$override->id));
$confirmurl = new lion_url($url, array('id'=>$override->id, 'confirm'=>1));
$cancelurl = new lion_url('/mod/quiz/overrides.php', array('cmid'=>$cm->id));
