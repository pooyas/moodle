...
class feedback_edit_add_question_form extends lionform {
...
class feedback_edit_use_template_form extends lionform {
...
class feedback_edit_create_template_form extends lionform {
    private $feedbackdata;
