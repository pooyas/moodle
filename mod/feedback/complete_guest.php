...
$url = new lion_url('/mod/feedback/complete_guest.php', array('id'=>$id));
...
$PAGE->navbar->add($strfeedbacks, new lion_url('/mod/feedback/index.php', $urlparams));
...
if ((empty($cm->visible) AND
        !has_capability('lion/course:viewhiddenactivities', $context)) AND
        $course->id != SITEID) {
...
if ($feedback_can_submit) {
    ...
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    $analysisurl = new lion_url('/mod/feedback/analysis.php', array('id'=>$id));
    if ($courseid > 0) {
