...
echo '<br />';
$continue = new lion_url('/mod/book/delete.php', array('id'=>$cm->id, 'chapterid'=>$chapter->id, 'confirm'=>1));
$cancel = new lion_url('/mod/book/view.php', array('id'=>$cm->id, 'chapterid'=>$chapter->id));
