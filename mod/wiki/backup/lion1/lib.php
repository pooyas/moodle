 ...
 */
class lion1_mod_wiki_handler extends lion1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /LION_BACKUP/COURSE/MODULES/MOD/WIKI does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'wiki', '/LION_BACKUP/COURSE/MODULES/MOD/WIKI',
                array(
                    'newfields' => array(
                        'introformat' => '0',
            ...
            new convert_path(
                'wiki_entries', '/LION_BACKUP/COURSE/MODULES/MOD/WIKI/ENTRIES',
                array(
                    'newfields' => array(
                        'synonyms' => '0',
                        'links' => 'collaborative',
            ...
            new convert_path(
                'wiki_entry', '/LION_BACKUP/COURSE/MODULES/MOD/WIKI/ENTRIES/ENTRY'
            ),
            new convert_path(
                'wiki_pages', '/LION_BACKUP/COURSE/MODULES/MOD/WIKI/ENTRIES/ENTRY/PAGES'
            ),
            new convert_path(
                'wiki_entry_page', '/LION_BACKUP/COURSE/MODULES/MOD/WIKI/ENTRIES/ENTRY/PAGES/PAGE',
                array(
                    'newfields' => array(
    ...
    /**
     * This is executed every time we have one /LION_BACKUP/COURSE/MODULES/MOD/WIKI
     * data available
     */
