...
if ($redirect && !course_get_format($course)->has_view_page() &&
        ...
        has_capability('lion/course:update', context_course::instance($course->id)))) {
    $redirect = false;
}
...
if ($redirect) {
    ...
    $fullurl = lion_url::make_file_url('/pluginfile.php', $path, $displaytype == RESOURCELIB_DISPLAY_DOWNLOAD);
    redirect($fullurl);
}
