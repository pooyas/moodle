...
$url = new lion_url('/mod/forum/discuss.php', array('d'=>$d));
if ($parent !== 0) {
...
$node = $forumnode->add(format_string($discussion->name), new lion_url('/mod/forum/discuss.php', array('d'=>$discussion->id)));
$node->display = false;
