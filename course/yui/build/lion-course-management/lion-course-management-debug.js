YUI.add('lion-course-management', function (Y, NAME) {

/**
 * Provides drop down menus for list of action links.
 *
 * @module lion-course-management
 */
...
Console.NAME = 'lion-course-management';
...
Console.prototype = {
    ...
    initializer : function() {
        Y.log('Initialising course category management console', 'info', 'lion-course-management');
    ...
    initialiseCategories : function(listing) {
        ...
        if (!this.categoriesinit) {
            ...
            Y.log(count+' categories being managed', 'info', 'lion-course-management');
        } else {
            Y.log(count+' new categories being managed', 'info', 'lion-course-management');
        }
    },
    ...
    initialiseCourses : function() {
        ...
        Y.log(count+' courses being managed', 'info', 'lion-course-management');
    },
    ...
    handleCourseDelegation : function(e) {
        ...
        if (course) {
            ...
            Y.log('Course with ID '+courseid+' could not be found for delegation', 'error', 'lion-course-management');
        }
    },
    ...
    handleCategoryDelegation : function(e) {
        ...
        if (category) {
            ...
            Y.log('Could not find category to delegate to.', 'error', 'lion-course-management');
        }
    },
    ...
    performAjaxAction : function(action, args, callback, context) {
        ...
        if (callback === null) {
            callback = function() {
                Y.log("'Action '"+action+"' completed", 'debug', 'lion-course-management');
            };
        }
...
Item.NAME = 'lion-course-management-item';
...
Item.prototype = {
    ...
    moveup : function(transactionid, response, args) {
        ...
        if (outcome === false) {
            Y.log('AJAX request to move '+this.get('itemname')+' up failed by outcome.', 'warn', 'lion-course-management');
            return false;
        }
        node = this.get('node');
        ...
        if (previous) {
            ...
            this.updated(true);
            Y.log('Success: '+this.get('itemname')+' moved up by AJAX.', 'info', 'lion-course-management');
        } else {
    ...
    movedown : function(transactionid, response, args) {
        var node,
            ...
            outcome = this.checkAjaxResponse(transactionid, response, args);
        if (outcome === false) {
            Y.log('AJAX request to move '+this.get('itemname')+' down failed by outcome.', 'warn', 'lion-course-management');
            return false;
        }
        node = this.get('node');
        ...
        if (next) {
            ...
            this.updated(true);
            Y.log('Success: '+this.get('itemname')+' moved down by AJAX.', 'info', 'lion-course-management');
        } else {
    ...
    show : function(transactionid, response, args) {
        ...
        this.updated();
        Y.log('Success: '+this.get('itemname')+' made visible by AJAX.', 'info', 'lion-course-management');
    },
    ...
    markVisible : function() {
        ...
        Y.log('Marked '+this.get('itemname')+' as visible', 'info', 'lion-course-management');
        return true;
    },
    ...
    markHidden : function() {
        ...
        Y.log('Marked '+this.get('itemname')+' as hidden', 'info', 'lion-course-management');
        return true;
    },
...
Course.NAME = 'lion-course-management-course';
...
Course.prototype = {
    ...
    handle : function(action, e) {
        ...
        switch (action) {
            ...
            case 'select':
                ...
                break;
            default:
                Y.log('Invalid AJAX action requested of managed course.', 'warn', 'lion-course-management');
                return false;
        }
    },
    ...
    moveAfterResponse : function(transactionid, response, args) {
        ...
        if (outcome === false) {
            ...
            Y.log('AJAX failed to move this course after the requested course', 'warn', 'lion-course-management');
            if (previous) {
        ...
        Y.log('AJAX successfully moved course ('+this.getName()+')', 'info', 'lion-course-management');
        this.highlight();
    }
};
