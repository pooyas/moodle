 ...
 *
 * The user selects if he wants to publish the course on a specific hub. 
 * The site must be registered on a hub to be able to
 * publish a course on it.
*/

// Note:
// Renaming required
// No intention of publishing for now
die();
