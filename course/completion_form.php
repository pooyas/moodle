 ...
 */
class course_completion_form extends lionform {
    ...
    public function definition() {
        ...
        $roles = get_roles_with_capability('lion/course:markcomplete', CAP_ALLOW, context_course::instance($course->id, IGNORE_MISSING));
