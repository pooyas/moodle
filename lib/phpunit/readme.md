PHPUnit testing support in Lion
==================================


Documentation
-------------
* [Lion PHPUnit integration](http://docs.lion.org/dev/PHPUnit)
...
It installs PHP libraries into /vendor/ subdirectory inside your lion dirroot.

1. install Composer - [http://getcomposer.org/doc/00-intro.md](http://getcomposer.org/doc/00-intro.md)
2. install PHUnit and dependencies - go to your Lion dirroot and execute `php composer.phar install --dev`
