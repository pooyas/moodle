// Miscellaneous core Javascript functions for Lion
...
M.util.image_url = function(imagename, component) {
    ...
    if (!component || component == '' || component == 'lion' || component == 'core') {
        component = 'core';
    }
...
M.util.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
    ...
    if (this.div.hasClass('collapsed')) {
        ...
        this.icon = Y.Node.create('<img src="'+M.util.image_url(collapsedimage, 'lion')+'" alt="" />');
        // Shrink the div as it is collapsed by default
        this.div.setStyle('height', caption.get('offsetHeight')+'px');
    } else {
        // Add the correct image and record the YUI node created in the process
        this.icon = Y.Node.create('<img src="'+M.util.image_url('t/expanded', 'lion')+'" alt="" />');
    }
    a.append(this.icon);
    ...
    animation.on('end', function() {
        ...
        if (this.div.hasClass('collapsed')) {
            this.icon.set('src', M.util.image_url(collapsedimage, 'lion'));
        } else {
            this.icon.set('src', M.util.image_url('t/expanded', 'lion'));
        }
    }, this);
...
/**
 * Makes a best effort to connect back to Lion to update a user preference,
 * however, there is no mechanism for finding out if the update succeeded.
 *
 * Before you can use this function in your JavsScript, you must have called
 * user_preference_allow_ajax_update from lionlib.php to tell Lion that
...
M.util.show_confirm_dialog = function(e, args) {
    ...
    YUI().use('lion-core-notification-confirm', function(Y) {
    ...
    Y.use('node', 'event-mouseenter', function(){
        ...
        var colourpicker = {
            ...
            init : function() {
                ...
                this.image.setAttribute('src', M.util.image_url('i/colourpicker', 'lion'));
        ...
        M.util.block_hider = M.util.block_hider || (function(){
            ...
            Y.extend(blockhider, Y.Base, blockhider.prototype, {
                ...
                ATTRS : {
                    ...
                    preference : {},
                    iconVisible : {
                        value : M.util.image_url('t/switch_minus', 'lion')
                    },
                    iconHidden : {
                        value : M.util.image_url('t/switch_plus', 'lion')
                    },
                    block : {
 ...
 */
YUI.add('lion-core-io', function(Y) {
 ...
 * same way as PHP get_string() in Lion does.
 *
...
M.util.add_lightbox = function(Y, node) {
    var WAITICON = {'pix':"i/loading_small",'component':'lion'};
...
// ===== Deprecated core Javascript functions for Lion ====
//       DO NOT USE!!!!!!!
...
/**
 * @method addonload
 * @deprecated since Lion 2.7 - please do not use this function any more.
 */
function addonload() {
