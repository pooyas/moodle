YUI.add('lion-editor_atto-editor', function (Y, NAME) {


/**
 * The Atto WYSIWG pluggable editor, written for Lion.
 *
...
var LOGNAME = 'lion-editor_atto-editor';
var CSS = {
...
// Function for Lion's initialisation.
...
EditorTextArea.prototype = {
    ...
    updateOriginal : function() {
        ...
        if (oldValue !== newValue) {
            ...
            // Trigger the onchange callback on the textarea, essentially to notify lion-core-formchangechecker.
 ...
 *
 * @module     lion-editor_atto-autosave
...
var SUCCESS_MESSAGE_TIMEOUT = 5000,
    ...
    LOGNAME_AUTOSAVE = 'lion-editor_atto-editor-autosave';
