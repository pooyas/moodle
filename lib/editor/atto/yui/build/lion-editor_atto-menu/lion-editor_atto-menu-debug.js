YUI.add('lion-editor_atto-menu', function (Y, NAME) {


/**
 * A Menu for the Atto editor.
 *
 * @module     lion-editor_atto-menu
 * @submodule  menu-base
 * @package    editor
 * @subpackage atto
...
var LOGNAME = 'lion-editor_atto-menu';
var MENUDIALOGUE = '' +
...
/**
 * A Menu for the Atto editor used in Lion.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.one('.lion-dialogue-wrap')
            .removeClass('lion-dialogue-wrap')
            .addClass('lion-dialogue-content');
...
}, '@VERSION@', {"requires": ["lion-core-notification-dialogue", "node", "event", "event-custom"]});
