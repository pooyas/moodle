YUI.add('lion-atto_accessibilitychecker-button', function (Y, NAME) {
...
/**
 * @module lion-atto_accessibilitychecker-button
 */
...
}, '@VERSION@', {"requires": ["color-base", "lion-editor_atto-plugin"]});
