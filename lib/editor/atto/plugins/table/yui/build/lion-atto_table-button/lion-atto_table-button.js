YUI.add('lion-atto_table-button', function (Y, NAME) {
...
}, '@VERSION@', {"requires": ["lion-editor_atto-plugin", "lion-editor_atto-menu", "event", "event-valuechange"]});
