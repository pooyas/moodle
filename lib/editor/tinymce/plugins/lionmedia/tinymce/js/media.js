...
// No need to require lang packs in lion plugins.
...
function generatePreview(c) {
    ...
    pl = tinyMCEPopup.editor.plugins.lionmedia._parse(pl);
    ...
    p.innerHTML = '<iframe src="' + tinyMCEPopup.editor.getParam("lion_plugin_base") + 'lionmedia/preview.php'
