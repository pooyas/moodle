/**
 * TinyMCE plugin LionEmoticon - provides GUI to insert emoticon images.
 *
...
(function() {
    tinymce.create('tinymce.plugins.LionEmoticon', {
        ...
        init : function(ed, url) {
            // Register the command so that it can be invoked by using tinyMCE.activeEditor.execCommand('mceLionEmoticon');
            ed.addCommand('mceLionEmoticon', function() {
                lang = ed.getParam('language');
                ed.windowManager.open({
                    file : ed.getParam("lion_plugin_base") + 'lionemoticon/dialog.php?lang=' + lang ,
                    width : 250 + parseInt(ed.getLang('lionemoticon.delta_width', 0)),
                    height : 400 + parseInt(ed.getLang('lionemoticon.delta_height', 0)),
                    inline : 1
                }, {
            ...
            ed.onInit.add(function(ed) {
                ...
                this._emoticons = tinymce.util.JSON.parse(ed.getParam('lionemoticon_emoticons'));
            ...
            // Register lionemoticon button.
            ed.addButton('lionemoticon', {
                title : 'lionemoticon.desc',
                cmd : 'mceLionEmoticon',
                image : url + '/img/lionemoticon.png'
            });
        },
    ...
    // Register plugin.
    tinymce.PluginManager.add('lionemoticon', tinymce.plugins.LionEmoticon);
})();
