...
$PAGE->set_url('/lib/editor/tinymce/plugins/lionemoticon/dialog.php');

$emoticonmanager = get_emoticon_manager();
$stringmanager = get_string_manager();

$editor = get_texteditor('tinymce');
$plugin = $editor->get_plugin('lionemoticon');
...
<head>
    <title><?php print_string('lionemoticon:desc', 'tinymce_lionemoticon'); ?></title>
