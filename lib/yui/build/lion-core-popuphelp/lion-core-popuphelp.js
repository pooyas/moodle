YUI.add('lion-core-popuphelp', function (Y, NAME) {

/**
 * A popup help dialogue for Lion.
 *
 * @module lion-core-popuphelp
 */
...
POPUPHELP.NAME = 'lion-core-popuphelp';
...
Y.extend(POPUPHELP, Y.Base, {
    ...
    display_panel: function(e) {
        if (!this.panel) {
            this.panel = new M.core.tooltip({
                ...
                initialheadertext: M.util.get_string('loadinghelp', 'lion'),
                initialfootertext: ''
            });
        }
    ...
    set_footer: function(helpobject) {
        // Check for an optional link to documentation on lion.org.
...
}, '@VERSION@', {"requires": ["lion-core-tooltip"]});
