YUI.add('lion-core-dragdrop', function (Y, NAME) {

/**
 * The core drag and drop module for Lion which extends the YUI drag and
 * drop functionality with additional features.
 *
 * @module lion-core-dragdrop
 */
var MOVEICON = {
    pix: "i/move_2d",
    largepix: "i/dragdrop",
    component: 'lion',
    cssclass: 'lion-core-dragdrop-draghandle'
};
...
Y.extend(DRAGDROP, Y.Base, {
    ...
    find_element_text: function(n) {
        ...
        return M.util.get_string('emptydragdropregion', 'lion');
    },
    ...
    global_start_keyboard_drag: function(e, draghandle, dragcontainer) {
        ...
        var dialogtitle = M.util.get_string('movecontent', 'lion', nodetitle);
        ...
        droptargets.each(function (node) {
            ...
            if (validdrop) {
                ...
                if (this.samenodelabel && node.hasClass(this.samenodeclass)) {
                    ...
                    listitemtext = M.util.get_string('tocontent', 'lion', nodetitle);
                }
...
}, '@VERSION@', {"requires": ["base", "node", "io", "dom", "dd", "event-key", "event-focus", "lion-core-notification"]});
