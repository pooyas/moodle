YUI.add('lion-core-notification-exception', function (Y, NAME) {
 ...
 * @submodule lion-core-notification-exception
 */

var EXCEPTION_NAME = 'Lion exception',
    EXCEPTION;
...
Y.extend(EXCEPTION, M.core.notification.info, {
    ...
    initializer : function(config) {
        ...
        this.setStdModContent(Y.WidgetStdMod.HEADER,
                '<h1 id="lion-dialogue-'+config.COUNT+'-header-text">' + Y.Escape.html(config.name) + '</h1>',
                Y.WidgetStdMod.REPLACE);
        content = Y.Node.create('<div class="lion-exception"></div>')
                .append(Y.Node.create('<div class="lion-exception-message">'+Y.Escape.html(this.get('message'))+'</div>'))
                .append(Y.Node.create('<div class="lion-exception-param hidden param-filename"><label>File:</label> ' +
                        Y.Escape.html(this.get('fileName'))+'</div>'))
                .append(Y.Node.create('<div class="lion-exception-param hidden param-linenumber"><label>Line:</label> ' +
