YUI.add('lion-core-dock', function (Y, NAME) {
 ...
 *
 * @module lion-core-dock
 */


var LOGNS = 'lion-core-dock',
...
Y.extend(DOCK, Y.Base, DOCK.prototype, {
    ...
    ATTRS : {
         ...
         */
        undockAllIconUrl: {
            value : M.util.image_url((window.right_to_left()) ? 't/dock_to_block_rtl' : 't/dock_to_block', 'lion'),
            validator : Y.Lang.isString
        }
    }
});
...
Y.extend(TABHEIGHTMANAGER, Y.Base, TABHEIGHTMANAGER.prototype, {
    NAME : 'lion-core-tabheightmanager',
    ATTRS : {
        /**
         * The dock.
         * @attribute dock
...
BLOCK.prototype = {
    ...
    moveToDock : function(e) {
        ...
        movetoimg = Y.Node.create('<img />').setAttrs({
            ...
            src : M.util.image_url(icon, 'lion')
        });
...
DOCKEDITEM.prototype = {
    ...
    draw : function() {
        ...
        closeiconimg.setAttribute('src', M.util.image_url('t/dockclose', 'lion'));
...
Y.extend(DOCKEDITEM, Y.Base, DOCKEDITEM.prototype, {
    NAME : 'lion-core-dock-dockeditem',
    ATTRS : {
        /**
