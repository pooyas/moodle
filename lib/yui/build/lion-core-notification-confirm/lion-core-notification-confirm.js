YUI.add('lion-core-notification-confirm', function (Y, NAME) {
 ...
 * @submodule lion-core-notification-confirm
 */

var CONFIRM_NAME = 'Lion confirmation dialogue',
    CONFIRM;
...
Y.extend(CONFIRM, M.core.notification.info, {
    ...
    initializer: function() {
        ...
        this.get(BASE).addClass('lion-dialogue-confirm');
        this.setStdModContent(Y.WidgetStdMod.BODY, content, Y.WidgetStdMod.REPLACE);
        this.setStdModContent(Y.WidgetStdMod.HEADER,
                '<h1 id="lion-dialogue-'+this.get('COUNT')+'-header-text">' + this.get(TITLE) + '</h1>', Y.WidgetStdMod.REPLACE);
    ...
    ATTRS: {
        ...
        yesLabel: {
            ...
            valueFn: function() {
                return M.util.get_string('yes', 'lion');
            },
        ...
        noLabel: {
            validator: Y.Lang.isString,
            valueFn: function() {
                return M.util.get_string('no', 'lion');
            },
            setter: function(value) {
                if (this._noButton) {
        ...
        title: {
            validator: Y.Lang.isString,
            value: M.util.get_string('confirm', 'lion')
        },
        ...
        question: {
            validator: Y.Lang.isString,
            valueFn: function() {
                return M.util.get_string('areyousure', 'lion');
            },
            setter: function(value) {
                if (this._question) {
