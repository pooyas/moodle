YUI.add('lion-core-dock-loader', function (Y, NAME) {

var LOADERNAME = 'lion-core-dock-loader';
...
M.core.dock.ensureMoveToIconExists = function(blocknode) {
    ...
    moveto.setAttribute('src', M.util.image_url(icon, 'lion'));
