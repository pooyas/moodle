YUI.add('lion-core-tooltip', function (Y, NAME) {

/**
 * Provides the base tooltip class.
 *
 * @module lion-core-tooltip
 */
 ...
 * @static
 */
TOOLTIP.NAME = 'lion-core-tooltip';
 ...
 * @static
 */
TOOLTIP.CSS_PREFIX = 'lion-dialogue';
...
/**
  ...
  *
  * The supplid string will be wrapped in a div with the CSS.PANELTEXT class and a standard Lion spinner
  * appended.
  *
...
Y.extend(TOOLTIP, M.core.dialogue, {
    ...
    initializer: function() {
        ...
        // set.
        this.bb.addClass('lion-dialogue-tooltip');
...
Y.Base.modifyAttrs(TOOLTIP, {
     ...
     *
     * Lion override: We override this for tooltip to default it to false.
     *
     * @attribute Modal
     * @type Boolean
     * @default false
