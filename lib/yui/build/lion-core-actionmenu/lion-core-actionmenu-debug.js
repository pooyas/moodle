YUI.add('lion-core-actionmenu', function (Y, NAME) {

/**
 * Provides drop down menus for list of action links.
 *
 * @module lion-core-actionmenu
 */
...
var BODY = Y.one(Y.config.doc.body),
    ...
    SELECTOR = {
        ...
        MENU : '.lion-actionmenu[data-enhance=lion-core-actionmenu]',
...
ACTIONMENU.prototype = {
    ...
    handleKeyboardEvent: function(e) {
        ...
        if (e.keyCode === 27) {
            ...
            if (!found) {
                Y.log("Unable to find this menu item in the list of menu children", 'debug', 'lion-core-actionmenu');
                return;
            }
