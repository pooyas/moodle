YUI.add('lion-core-formchangechecker', function (Y, NAME) {

/**
 * A utility to check for form changes before navigating away from a page.
 *
 * @module lion-core-formchangechecker
 */
...
M.core_formchangechecker.report_form_dirty_state = function(e) {
    ...
    var warningmessage = M.util.get_string('changesmadereallygoaway', 'lion');
