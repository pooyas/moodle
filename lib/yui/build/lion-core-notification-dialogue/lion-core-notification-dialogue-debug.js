YUI.add('lion-core-notification-dialogue', function (Y, NAME) {
...
M.core = M.core || {};
/**
 * The generic dialogue class for use in Lion.
 *
 * @module lion-core-notification
 * @submodule lion-core-notification-dialogue
 */

var DIALOGUE_NAME = 'Lion dialogue',
    DIALOGUE,
    ...
    DOT = '.',
    HAS_ZINDEX = 'lion-has-zindex',
    CAN_RECEIVE_FOCUS_SELECTOR = 'input:not([type="hidden"]), a[href], button, textarea, select, [tabindex]';

/**
 * A re-usable dialogue box with Lion classes applied.
 *
...
DIALOGUE = function(c) {
    ...
    var id = 'lion-dialogue-' + config.COUNT;
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    ATTRS : {
         ...
         * @type Boolean
         * @default true
         * @deprecated Since Lion 2.7. Please use modal instead.
         */
        lightbox: {
            lazyAdd: false,
            setter: function(value) {
                Y.log("The lightbox attribute of M.core.dialogue has been deprecated since Lion 2.7, " +
                      "please use the modal attribute instead",
                    'warn', 'lion-core-notification-dialogue');
        ...
        closeButtonTitle : {
            ...
            value: M.util.get_string('closebuttontitle', 'lion')
        },
...
Y.Base.modifyAttrs(DIALOGUE, {
     ...
     * `align` Attribute.
     *
     * Note: We override this in Lion such that it sets a value for the
...
Y.extend(INFO, M.core.dialogue, {
    ...
    NAME: 'Lion information dialogue',
    CSS_PREFIX: DIALOGUE_PREFIX
});
...
M.core.notification.info = INFO;
    ...
    "requires": [
        ...
        "event-key",
        "dd-plugin",
        "lion-core-widget-focusafterclose",
        "lion-core-lockscroll"
    ]
});
