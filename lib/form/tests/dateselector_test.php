...
/**
 * Unit tests for LionQuickForm_date_selector
 *
 * Contains test cases for testing LionQuickForm_date_selector
 *
 * @package    core
 * @category   phpunit
 * @copyright  2015 Pooya Saeedi
...
class core_form_dateselector_testcase extends basic_testcase {
    ...
    public function test_exportvalue() {
        ...
        foreach ($testvals as $vals) {
            ...
            $el = new LionQuickForm_date_selector('dateselector', null, $elparams);
            $el->_createElements();
 ...
 */
class temp_form_date extends lionform {
    /**
     * Form definition.
     */
