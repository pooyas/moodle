...
class LionQuickForm_date_selector extends LionQuickForm_group {
     ...
     */
    function LionQuickForm_date_selector($elementName = null, $elementLabel = null, $options = array(), $attributes = null) {
    ...
    function _createElements() {
        ...
        foreach ($dateformat as $key => $value) {
            ...
            $this->_elements[] = @LionQuickForm::createElement('select', $key, get_string($key, 'form'), $value, $this->getAttributes(), true);
        }
