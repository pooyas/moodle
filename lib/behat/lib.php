 ...
 *
 * It does not include LION_INTERNAL because is part of the bootstrap.
 *
 ...
 * lion setup.php. For places requiring a different/special behavior
...
function behat_error_handler($errno, $errstr, $errfile, $errline, $errcontext) {
    ...
    // the lion code (see fix_utf8() for example) in that cases we respect the forced error level value.
