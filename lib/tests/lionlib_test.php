...
/**
 * Unit tests for (some of) ../lionlib.php.
 *
 * @package    core
 * @category   phpunit
...
class core_lionlib_testcase extends advanced_testcase {

    public static $includecoverage = array('lib/lionlib.php');
    ...
    public function test_optional_param() {
        ...
        // Make sure warning is displayed if array submitted - TODO: throw exception in Lion 2.3.
    ...
    public function test_required_param() {
        ...
        try {
            ...
            $this->assertInstanceOf('lion_exception', $ex);
        }
     ...
     * output using Lion TZ/DST support and PHP native one.
     *
     ...
     */
    public function test_some_lion_special_dst() {
        ...
        $lionres = userdate($stamp, '%Y/%m/%d %H:%M:%S', 'Europe/Tallinn', false); // Lion result.
        $this->assertSame($expectation, $phpres);
        $this->assertSame($expectation, $lionres);
        ...
        $phpres = $phpdt->format('Y/m/d H:i:s'); // PHP result.
        $lionres = userdate($stamp, '%Y/%m/%d %H:%M:%S', 'America/St_Johns', false); // Lion result.
        $this->assertSame($expectation, $phpres);
        $this->assertSame($expectation, $lionres);
