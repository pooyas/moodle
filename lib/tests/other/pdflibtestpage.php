...
if ($getpdf) {
    ...
    $doc->SetTitle('Lion PDF library test');
    $doc->SetAuthor('Lion ' . $CFG->release);
    $doc->SetCreator('lib/tests/other/pdflibtestpage.php');
    $doc->SetKeywords('Lion, PDF');
    $doc->SetSubject('This has been generated by Lion as its PDF library test page');
    $doc->SetMargins(15, 30);

    $doc->setPrintHeader(true);
    $doc->setHeaderMargin(10);
    $doc->setHeaderFont(array($fontfamily, 'b', 10));
    $doc->setHeaderData('pix/lionlogo-med.png', 40, $SITE->fullname, $CFG->wwwroot);
    ...
    $doc->Cell(0, 0, 'Lion PDF library test', 0, 1, 'C', 1);
...
echo $OUTPUT->continue_button(new lion_url($PAGE->url, array('getpdf' => 1, 'fontfamily' => PDF_FONT_NAME_MAIN)));
echo $OUTPUT->footer();
