...
class core_lion_page_testcase extends advanced_testcase {

    /**
     * @var testable_lion_page
     */
    protected $testpage;
    ...
    public function setUp() {
        parent::setUp();
        $this->resetAfterTest();
        $this->testpage = new testable_lion_page();
    }
    ...
    public function test_set_state_normal_path() {
        ...
        $this->assertEquals(lion_page::STATE_BEFORE_HEADER, $this->testpage->state);

        $this->testpage->set_state(lion_page::STATE_PRINTING_HEADER);
        $this->assertEquals(lion_page::STATE_PRINTING_HEADER, $this->testpage->state);

        $this->testpage->set_state(lion_page::STATE_IN_BODY);
        $this->assertEquals(lion_page::STATE_IN_BODY, $this->testpage->state);

        $this->testpage->set_state(lion_page::STATE_DONE);
        $this->assertEquals(lion_page::STATE_DONE, $this->testpage->state);
    }
    ...
    public function test_url_to_class_name() {
        ...
        $this->assertSame('example-com--lion', $this->testpage->url_to_class_name('https://example.com/lion'));
        $this->assertSame('example-com--8080--nested-lion', $this->testpage->url_to_class_name('https://example.com:8080/nested/lion'));
    }
    ...
    public function test_set_url_using_lion_url() {
        global $CFG;
        // Fixture setup.
        $url = new lion_url('/mod/workshop/allocation.php', array('cmid' => 29, 'method' => 'manual'));
        // Exercise SUT.
    ...
    public function test_default_editing_capabilities() {
        ...
        // Validated.
        $this->assertEquals(array('lion/site:manageblocks'), $this->testpage->all_editing_caps());
    }
    ...
    public function test_other_block_editing_cap() {
        ...
        // Exercise SUT.
        $this->testpage->set_blocks_editing_capability('lion/my:manageblocks');
        // Validated.
        $this->assertEquals(array('lion/my:manageblocks'), $this->testpage->all_editing_caps());
    }
    ...
    public function test_other_editing_cap() {
        ...
        // Exercise SUT.
        $this->testpage->set_other_editing_capability('lion/course:manageactivities');
        // Validated.
        $actualcaps = $this->testpage->all_editing_caps();
        $expectedcaps = array('lion/course:manageactivities', 'lion/site:manageblocks');
    ...
    public function test_other_editing_caps() {
        ...
        // Exercise SUT.
        $this->testpage->set_other_editing_capability(array('lion/course:manageactivities', 'lion/site:other'));
        // Validated.
        $actualcaps = $this->testpage->all_editing_caps();
        $expectedcaps = array('lion/course:manageactivities', 'lion/site:other', 'lion/site:manageblocks');
        $this->assertEquals(array_values($expectedcaps), array_values($actualcaps));
    }
 ...
 */
class testable_lion_page extends lion_page {
