...
require_once(__DIR__.'/pgsql_native_lion_recordset.php');
require_once(__DIR__.'/pgsql_native_lion_temptables.php');
...
class pgsql_native_lion_database extends lion_database {
    ...
    public function connect($dbhost, $dbuser, $dbpass, $dbname, $prefix, array $dboptions=null) {
        ...
        $this->temptables = new pgsql_native_lion_temptables($this);
    ...
    protected function query_end($result) {
        ...
        try {
            ...
            if ($this->savepointpresent and $this->last_type != SQL_QUERY_AUX and $this->last_type != SQL_QUERY_SELECT) {
                $res = @pg_query($this->pgsql, "RELEASE SAVEPOINT lion_pg_savepoint; SAVEPOINT lion_pg_savepoint");
                if ($res) {
                    pg_free_result($res);
                }
            }
            ...
            if ($this->savepointpresent) {
                $res = @pg_query($this->pgsql, "ROLLBACK TO SAVEPOINT lion_pg_savepoint; SAVEPOINT lion_pg_savepoint");
                if ($res) {
                    pg_free_result($res);
                }
            }
    ...
    protected function create_recordset($result) {
        return new pgsql_native_lion_recordset($result, $this->bytea_oid);
    }
    ...
    public function get_session_lock($rowid, $timeout) {
        ...
        //       multiple instances of lion, we could try to use pg_advisory_lock(int, int),
    ...
    protected function begin_transaction() {
        ...
        $sql = "BEGIN ISOLATION LEVEL READ COMMITTED; SAVEPOINT lion_pg_savepoint";
        $this->query_start($sql, NULL, SQL_QUERY_AUX);
        $result = pg_query($this->pgsql, $sql);
        $this->query_end($result);
    ...
    protected function commit_transaction() {
        ...
        $sql = "RELEASE SAVEPOINT lion_pg_savepoint; COMMIT";
        $this->query_start($sql, NULL, SQL_QUERY_AUX);
        $result = pg_query($this->pgsql, $sql);
        $this->query_end($result);
    ...
    protected function rollback_transaction() {
        $this->savepointpresent = false;
        $sql = "RELEASE SAVEPOINT lion_pg_savepoint; ROLLBACK";
        $this->query_start($sql, NULL, SQL_QUERY_AUX);
        $result = pg_query($this->pgsql, $sql);
        $this->query_end($result);
