...
require_once(__DIR__.'/pdo_lion_database.php');
 ...
 * 
 */
class sqlite3_pdo_lion_database extends pdo_lion_database {
    ...
    protected function configure_dbconnection() {
        ...
        // this is required in case that the liondata folder is web accessible and
     ...
     * else the file will be <lion data path>/<dbname>.sq3.php
