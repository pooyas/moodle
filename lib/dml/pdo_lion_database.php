...
require_once(__DIR__.'/pdo_lion_recordset.php');
...
abstract class pdo_lion_database extends lion_database {
    ...
    /**
     * Factory method that creates a recordset for return by a query. The generic pdo_lion_recordset
     * class should fit most cases, but pdo_lion_database subclasses can override this method to return
     * a subclass of pdo_lion_recordset.
     * @param object $sth instance of PDOStatement
     * @return object instance of pdo_lion_recordset
     */
    protected function create_recordset($sth) {
        return new pdo_lion_recordset($sth);
    }
    ...
    /**
     * Get a number of records as an lion_recordset.  $sql must be a complete SQL query.
