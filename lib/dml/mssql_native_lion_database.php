...
require_once(__DIR__.'/mssql_native_lion_recordset.php');
...
class mssql_native_lion_database extends lion_database {
    ...
    public function connect($dbhost, $dbuser, $dbpass, $dbname, $prefix, array $dboptions=null) {
        ...
        $this->temptables = new mssql_native_lion_temptables($this);
    ...
    public function get_columns($table, $usecache=true) {
        ...
        while ($rawcolumn = mssql_fetch_assoc($result)) {
            ...
            $info->meta_type = $this->mssqltype2liontype($info->type);
    ...
    /**
     * Provides mapping between mssql native data types and lion_database - database_column_info - ones)
     *
     * @param string $mssql_type native mssql data type
     * @return string 1-char database_column_info data type
     */
    private function mssqltype2liontype($mssql_type) {
        $type = null;
    ...
    protected function create_recordset($result) {
        return new mssql_native_lion_recordset($result);
    }
   ...
   /**
    ...
    public function sql_substr($expr, $start, $length=false) {
        if (count(func_get_args()) < 2) {
            throw new coding_exception('lion_database::sql_substr() requires at least two parameters', 'Originaly this function wa
