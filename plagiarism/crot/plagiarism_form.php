...
class plagiarism_setup_form extends lionform {
...
///Preventing the warning
        $mform->setType('crot_grammarsize',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_windowsize',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_colours',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_clusterdist',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_clustersize',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_threshold',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_global_threshold',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_live_key',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_global_search_query_size',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_percentage_of_search_queries',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_number_of_web_documents',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_culture_info',PARAM_RAW);
...
///CODEADDED(Pooya)
///Preventing the warning
        $mform->setType('crot_max_file_size',PARAM_RAW);
