...
$url = new lion_url('/admin/roles/assign.php', array('contextid' => $contextid));
...
if ($roleid) {
    ...
    // Print the form.
    $assignurl = new lion_url($PAGE->url, array('roleid'=>$roleid));
    if ($returnto !== null) {
...
<?php
    ...
    $newroleurl = new lion_url($PAGE->url);
    if ($returnto !== null) {
    ...
    $backurl = new lion_url('/admin/roles/assign.php', array('contextid' => $contextid));
    if ($returnto !== null) {
