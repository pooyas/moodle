...
M.core_role.init_cap_table_filter = function(Y, tableid, contextid) {
    ...
    CapTableFilter.prototype = {
        ...
        initializer : function() {
            ...
            this.label = Y.Node.create('<label for="'+this.input.get('id')+'">'+M.util.get_string('filter', 'lion')+' </label>');
            // Create a clear button to clear the input.
            this.button = Y.Node.create('<input type="button" value="'+M.util.get_string('clear', 'lion')+'" />').set('disabled', filtervalue=='');
