    ...
    public function edit_table(array $filetypes, array $deleted, $restricted) {
        ...
        if (count($combined) > 1) {
            ...
            foreach ($combined as $extension => $filetype) {
                ...
                $reverturl = new \lion_url('/admin/tool/filetypes/revert.php',
        ...
        if (!$restricted) {
            $out .= $this->single_button(new lion_url('/admin/tool/filetypes/edit.php',
