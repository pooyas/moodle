...
/**
 * Resets a file type to the default Lion values.
 *
...
$PAGE->set_url(new \lion_url('/admin/tool/filetypes/revert.php', array('extension' => $extension)));
...
$reverturl = new \lion_url('revert.php', array('extension' => $extension, 'revert' => 1));
