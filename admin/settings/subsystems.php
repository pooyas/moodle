...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $options = array(DAYSECS=>new lang_string('secondstotime86400'), WEEKSECS=>new lang_string('secondstotime604800'), 2620800=>new lang_string('nummonths', 'lion', 1), 15724800=>new lang_string('nummonths', 'lion', 6),0=>new lang_string('never'));
