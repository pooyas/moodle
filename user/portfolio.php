...
$url = new lion_url('/user/portfolio.php', array('courseid' => $courseid));
...
if (!empty($config)) {
    navigation_node::override_active_url(new lion_url('/user/portfolio.php', array('courseid' => $courseid)));
