 ...
 * Sample cron entry:
 * # 5 minutes past 4am
 * 5 4 * * * $sudo -u www-data /usr/bin/php /var/www/lion/auth/ldap/cli/sync_users.php
 *
 * Notes:
...
require(dirname(dirname(dirname(dirname(__FILE__)))).'/config.php'); // global lion config file.
