...
navigation_node::override_active_url(new lion_url('/admin/settings.php', array('section'=>'manageauths')));
...
if (!$auth) {
    ...
    $url = new lion_url('/auth/test_settings.php', array('sesskey'=>sesskey()));
