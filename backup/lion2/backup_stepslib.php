...
abstract class backup_activity_structure_step extends backup_structure_step {
    ...
    protected function add_subplugin_structure($subplugintype, $element, $multiple) {
        ...
        foreach ($subpluginsdirs as $name => $subpluginsdir) {
            ...
            $backupfile = $subpluginsdir . '/backup/lion2/' . $classname . '.class.php';
 ...
 * using one specialised nested_element, will copy them form lion storage
 * to backup storage
 */
...
/**
 * Structure step in charge of creating the main lion_backup.xml file
...
class backup_main_structure_step extends backup_structure_step {
    ...
    protected function define_structure() {
        ...
        $info['lion_version'] = $CFG->version;
        $info['lion_release'] = $CFG->release;
        ...
        $lion_backup = new backup_nested_element('lion_backup');

        $information = new backup_nested_element('information', null, array(
            'name', 'lion_version', 'lion_release', 'backup_version',
        ...
        $lion_backup->add_child($information);
        ...
        // Prepare some information to be sent to main lion_backup.xml file
        return $lion_backup;
    }
...
class backup_zip_contents extends backup_execution_step implements file_progress {
    ...
    protected function define_execution() {
        ...
        if (file_exists($logfilepath)) {
             $files['lion_backup.log'] = $logfilepath;
        }
        ...
        // Get the zip packer
        $zippacker = get_file_packer('application/vnd.lion.backup');
