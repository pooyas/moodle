...
class core_backup_lion2_testcase extends advanced_testcase {
    ...
    /**
     * The availability data format was changed in Lion 2.7. This test
     * ensures that a Lion 2.6 backup with this data can still be correctly
     * restored.
     */
    public function test_restore_legacy_availability() {
        ...
        get_file_packer('application/vnd.lion.backup')->extract_to_pathname(
    ...
    public function test_restore_frontpage() {
        ...
        $frontpagebc = new backup_controller(backup::TYPE_1COURSE, $frontpage->id,
                backup::FORMAT_LION, backup::INTERACTIVE_NO, backup::MODE_IMPORT,
                $USER->id);
    ...
    protected function duplicate($course, $cmid) {
        ...
        // Do backup.
        $bc = new backup_controller(backup::TYPE_1ACTIVITY, $cmid, backup::FORMAT_LION,
