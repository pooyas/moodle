 ...
 * mod/MODULENAME/backup/lion2/backup_MODULENAME_activity_task.class.php
...
abstract class backup_activity_task extends backup_task {
    ...
    public function __construct($name, $moduleid, $plan = null) {
        ...
        // Check activity supports this lion2 backup format
        if (!plugin_supports('mod', $coursemodule->modname, FEATURE_BACKUP_LION2)) {
            throw new backup_task_exception('activity_task_activity_lacks_lion2_backup_support', $coursemodule->modname);
        }
