...
/**
 * Tests for Lion format backup operation.
 *
 * @package core
 * @subpackage backup
...
class core_backup_moodle2_testcase extends advanced_testcase {
    ...
    /**
     * The availability data format was changed. This test
     * ensures that a Lion backup with this data can still be correctly
     * restored.
     */
